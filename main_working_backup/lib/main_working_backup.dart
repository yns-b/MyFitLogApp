            ...
            onPressed: () {
              showDialog(
                ...
                builder: (context) => AlertDialog(
                  ...
                  content: Text('Tüm istatistik verileri silinecek. Devam etmek istiyor musunuz?'),
                  actions: [
                    TextButton(
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            ...
            Flexible(
              child: Text(
                globalLanguage == 'Türkçe' ? 'Haftalık Rutinini Seç' : 'Select Weekly Routine',
                style: TextStyle(fontSize: context.responsiveTitleFontSize),
