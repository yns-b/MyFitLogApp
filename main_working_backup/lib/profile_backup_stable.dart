                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Container(
                                  ...
                                  padding: EdgeInsets.all(12),
                                  decoration: BoxDecoration(
                                    color: isLatest ? Colors.purple.withOpacity(0.1) : Colors.grey.withOpacity(0.05),
                                    borderRadius: BorderRadius.circular(8),
                                    border: Border.all(
                                      color: isLatest ? Colors.purple.withOpacity(0.3) : Colors.grey.withOpacity(0.2),
                                    ),
                                  ),
                                  child: Row(
                                    children: [
                                      Icon(
                                        ...
                                        color: isLatest ? Colors.purple : Colors.grey[600],
                                        size: 20,
                                      ),
                                      SizedBox(width: 12),
                                      Expanded(
                                          ...
                                          children: [
                                            Text(
                                              ...
                                              style: TextStyle(
                                                fontSize: 16,
                                                fontWeight: FontWeight.bold,
                                                color: isLatest ? Colors.purple[700] : Colors.grey[700],
                                              ),
                                            ),
                                            Text(
                        ...
                        Expanded(
                          child: ElevatedButton.icon(
                            ...
                            onPressed: () async {
                              ...
                              if (newTime != null) {
                                print('Yeni tartılma saati seçildi: ' + newTime.format(context));
                                setState(() {
                                ...
                                if (_weightReminderEnabled) {
                                  print('scheduleWeightReminder çağrılıyor: ' + newTime.format(context) + ', ' + _weightReminderFrequency);
                                  await NotificationService.scheduleWeightReminder(
                                    time: newTime,
                                    frequency: _weightReminderFrequency,
                                  );
                        ...
                        Expanded(
                          child: ElevatedButton.icon(
                            ...
                            onPressed: () async {
                              ...
                              if (newTime != null) {
                                print('Yeni su saati seçildi: ' + newTime.format(context));
                                setState(() {
                                ...
                                if (_waterReminderEnabled) {
                                  print('scheduleWaterReminder çağrılıyor: ' + newTime.format(context) + ', ' + _waterReminderInterval);
                                  await NotificationService.scheduleWaterReminder(
                                    time: newTime,
                                    interval: _waterReminderInterval,
                                  );
