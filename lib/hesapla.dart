...
// log10 helper for formulas (Dart's log is natural log)
double log10num(double x) {
  return log(x) / log(10);
}
...
class _HesaplaScreenState extends State<HesaplaScreen> {
  ...
  void _calculateBodyFat() {
    ...
    // US Navy method expects inches; convert cm → in
    final heightIn = height / 2.54;
    final neckIn = neck / 2.54;
    final waistIn = waist / 2.54;
    final hipIn = hip != null ? hip / 2.54 : null;
    ...
    if (_selectedGender == 'Erkek') {
      ...
      bodyFatPercentage = 495 / (1.0324 - 0.19077 * log10num(waistIn - neckIn) + 0.15456 * log10num(heightIn)) - 450;
    } else {
      // Kadın için kalça değeri gerekli
      if (hipIn == null || (waistIn + hipIn) <= neckIn || heightIn <= 0) {
        return;
      }
      bodyFatPercentage = 495 / (1.29579 - 0.35004 * log10num(waistIn + hipIn - neckIn) + 0.22100 * log10num(heightIn)) - 450;
    }

    // Sonucu makul aralıkta sınırla
    if (bodyFatPercentage.isNaN || bodyFatPercentage.isInfinite) {
      return;
    }
    bodyFatPercentage = (bodyFatPercentage.clamp(2.0, 60.0)) as double;
  ...
  Color _getCategoryColor(String category) {
    switch (category) {
      ...
      case 'Obez':
        return AppColorTheme.error;
      default:
        return AppColorTheme.textLight;
    }
  }
              ...
              child: Stack(
                children: [
                  ...
                  ClipRRect(
                    borderRadius: BorderRadius.circular(20),
                    child: Image.asset(
                      'assets/weight_loss_background.jpg', // Görsel dosya adını buraya yazın
                      fit: BoxFit.cover,
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.calculate, color: AppColorTheme.secondary),
                        SizedBox(width: 8),
                        Text(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(Icons.restaurant_menu, color: AppColorTheme.success),
                          SizedBox(width: 8),
                          Text(
